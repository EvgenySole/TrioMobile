...
import com.example.testandro6.databinding.FragmentAddObjectDoneBinding
import com.google.android.material.navigation.NavigationBarView

class AddObjectDoneFragment : Fragment() {
    companion object{
    ...
    private var _binding: FragmentAddObjectDoneBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAddObjectDoneBinding.inflate(inflater, container, false)
        val root: View = binding.root
        navBar = requireActivity().findViewById(R.id.bottomNavigationView)
        navBar?.visibility = View.VISIBLE

        if (SendData.data == "object updated"){
            binding.textNumEvent.setText("Объект обновлен!")
        }
        if (SendData.data == "object error"){
        ...
        buttonBack.setOnClickListener {
            ...
            navigate(R.id.action_fragment_add_object_done_to_navigation_tasks) }
        }
